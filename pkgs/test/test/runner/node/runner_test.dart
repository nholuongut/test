...
void main() {
  ...
  group('fails gracefully if', () {
    ...
    test("a test file doesn't have a main defined", () async {
      ...
      await test.shouldExit(1);
    }, skip: 'https://github.com/nholuongut/test/issues/894');
  ...
  test(
    ...
    () async {
      ...
      // regression test for https://github.com/nholuongut/test/pull/2259#issuecomment-2307868442
      await d.file('test.dart', '''
        import 'package:test/test.dart';
  ...
  test('dartifies stack traces for JS-compiled tests by default', () async {
    ...
    expect(test.stdout,
        ...
        skip: 'https://github.com/nholuongut/sdk/issues/41949');
    await test.shouldExit(1);
  });
