...
void main(List<String> args) async {
  ...
  test.completeShutdown();
    ...
    'windows': Skip('https://github.com/nholuongut/test/issues/1615')
  });
...
''').create();
      ...
      for (var platform in ['vm', 'chrome']) {
        test('on the $platform platform', () async {
          ...
          await test.shouldExit(0);
        }, skip: 'https://github.com/nholuongut/test/issues/1813');
      }
    });
  });
...
''').create();
    ...
    test('on the browser platform', () async {
      ...
      await test.shouldExit(0);
    }, skip: 'https://github.com/nholuongut/test/issues/1803');
  });
}
